defmodule ElixirTelegramWeb.UserControllerTest do
  use ElixirTelegramWeb.ConnCase

  alias ElixirTelegram.Authentication
  alias ElixirTelegram.Authentication.User
